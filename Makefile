BUILD = build
MAKEFILE = Makefile
OUTPUT_FILENAME = "Die_Stella_Polare_im_Eismeer"
TITLE_NAME = "Die Stella Polare im Eismeer."
...
PREFACE_EPUB = chapters/preface/preface_epub.md chapters/preface/00_Einleitung_epub.md
PREFACE_HTML_PDF = chapters/preface/preface_epub.md chapters/preface/00_Einleitung_pdf_html.md
...
$(BUILD)/pdf/$(OUTPUT_FILENAME).pdf: $(MAKEFILE) $(METADATA) $(CHAPTERS) $(CSS_FILE) $(IMAGES) $(COVER_IMAGE) $(METADATA_PDF) $(PREFACE_EPUB)
	mkdir -p $(BUILD)/pdf
	cp  *.css  $(IMAGES_FOLDER)
	cp  $(IMAGES_FOLDER)/Stella_Polare_*.jpg .
